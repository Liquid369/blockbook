...
// magic numbers
const (
	MainnetMagic wire.BitcoinNet = 0x0218d49d
	TestnetMagic wire.BitcoinNet = 0xe1c1f3cf
)
...
func init() {
	...
	MainNetParams.Bech32HRPSegwit = "mc"

	TestNetParams = chaincfg.TestNet3Params
	TestNetParams.Net = TestnetMagic
	TestNetParams.PubKeyHashAddrID = []byte{110}
	TestNetParams.ScriptHashAddrID = []byte{187}
	TestNetParams.Bech32HRPSegwit = "tm"
}
